...
static int asn_DFL_5_cmp_12800(const void *sptr) {
	const ETSI_ITS_CDD_DeltaAltitude_t *st = sptr;
...
static int asn_DFL_5_set_12800(void **sptr) {
	ETSI_ITS_CDD_DeltaAltitude_t *st = *sptr;
...
static int asn_DFL_6_cmp_15(const void *sptr) {
	const ETSI_ITS_CDD_AltitudeConfidence_t *st = sptr;
...
static int asn_DFL_6_set_15(void **sptr) {
	ETSI_ITS_CDD_AltitudeConfidence_t *st = *sptr;
...
asn_TYPE_member_t asn_MBR_PathPointPredicted_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PathPointPredicted, altitudeConfidence),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ETSI_ITS_CDD_AltitudeConfidence,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
